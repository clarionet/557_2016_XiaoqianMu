...
int main(int argc, const char * argv[])
{
    ...
    //int texid = texture->loadAndCreateTexture("../../data/textures/color.bmp");
    GLMultiTexture* textures=new GLMultiTexture();
    int texid1=textures->loadAndCreateTextures("../../data/textures/Wolf-2.bmp","../../data/textures/SuperMoon.bmp","../../data/textures/color.bmp");
    apperance_0->setTexture(textures);
    ...
    static const GLfloat clear_color[] = { .6f, 0.7f, 1.0f, 1.0f };
    ...
    while(!glfwWindowShouldClose(window))
    {
        ...
        bool ret = textures->setTextureBlendMode(g_change_texture_blend);
